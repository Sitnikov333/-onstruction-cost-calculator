...
namespace WindowsFormsApp3
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            t.SetToolTip(label13, "Обшивка наружных стен СНАРУЖИ (Фасадная ветрозащита теплозвукоизоляционная плита «ISOPLAAT» 25мм)");
            t.SetToolTip(label10, "Конструкции каркаса стен (Наружные 150мм,  внутренние 100мм), Конструкции перекрытия, стропильная система. Без утепления и обшивки стен, перекрытий");
            t.SetToolTip(label8, "Обшивка наружных стен СНАРУЖИ OSB 9мм");
            t.SetToolTip(label9, "Утепление каркаса  (Наружные 150мм,  внутренние 100мм),Перекрытие 150мм, Кровля 200мм. Термо плита 037");
